...
Arctic Fox will build for Mac OS X 10.6 and up, i386/x86_x64/PowerPC Linux, and more than likely any other unix/bsd varient as well. Ideally, we'd like to get it working on PowerPC 10.5 as well.
