...
add_task(function*() {
  ...
  is (image.getAttribute("src"), "chrome://global/skin/devtools/tool-options.svg", "The icon has been set correctly");

  info ("About to set project with new options.");
  yield projecteditor.setProjectToAppPath(TEMP_PATH, {
    name: "Test2",
    iconUrl: "chrome://global/skin/devtools/tool-inspector.svg",
    projectOverviewURL: SAMPLE_WEBAPP_URL,
  ...
  is (image.getAttribute("src"), "chrome://global/skin/devtools/tool-inspector.svg", "The icon has been set correctly");

  info ("About to set project with new options.");
  yield projecteditor.setProjectToAppPath(TEMP_PATH, {
    name: "Test3",
    iconUrl: "chrome://global/skin/devtools/tool-webconsole.svg",
    projectOverviewURL: SAMPLE_WEBAPP_URL,
  ...
  is (image.getAttribute("src"), "chrome://global/skin/devtools/tool-webconsole.svg", "The icon has been set correctly");

  info ("About to set project with new options.");
  yield projecteditor.setProjectToAppPath(TEMP_PATH, {
    name: "Test4",
    iconUrl: "chrome://global/skin/devtools/tool-debugger.svg",
    projectOverviewURL: SAMPLE_WEBAPP_URL,
  ...
  is (image.getAttribute("src"), "chrome://global/skin/devtools/tool-debugger.svg", "The icon has been set correctly");
