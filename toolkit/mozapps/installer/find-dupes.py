...
ALLOWED_DUPES = set([
    ...
    # added for current AcrticFox compatibility - Riccardo Mottola - check in the future
    # (I think several of these are real duplicates that need to be fixed)
    'browser/chrome/browser/skin/classic/browser/Push-16.png',
    'browser/chrome/browser/skin/classic/browser/Push-64.png',
    ...
    'modules/devtools/scratchpad/scratchpad-commands.js',
    'chrome/toolkit/content/global/devtools/scratchpad-commands.js',
    'chrome/toolkit/skin/classic/global/devtools/profiler-stopwatch.svg',
    'chrome/toolkit/skin/classic/global/devtools/tool-profiler.svg',
    'browser/chrome/browser/skin/classic/browser/webapps-16.png',
    'chrome/toolkit/skin/classic/global/icons/webapps-16.png',
    'modules/devtools/commandline/commands-index.js',
    'chrome/toolkit/content/global/devtools/commandline/commands-index.js',
    ...
    'chrome/toolkit/content/global/devtools/responsivedesign/resize-commands.js',
    'modules/devtools/projecteditor/helpers/readdir.js',
    'chrome/toolkit/content/global/devtools/readdir.js',
    'modules/devtools/shared/theme-switching.js',
    'chrome/toolkit/content/global/devtools/theme-switching.js',
    'modules/devtools/shared/frame-script-utils.js',
    'chrome/toolkit/content/global/devtools/frame-script-utils.js',
    'chrome/toolkit/skin/classic/global/inContentUI/background-texture.png',
    'browser/modules/promise.js',
    'modules/commonjs/sdk/core/promise.js',
    ...
    'chrome/toolkit/skin/classic/global/devtools/noise.png',
    'browser/chrome/browser/skin/classic/browser/imagedocument.png',
    'browser/chrome/browser/skin/classic/browser/webapps-64.png',
    'chrome/toolkit/skin/classic/global/icons/webapps-64.png',
    ...
    'modules/devtools/framework/toolbox-options.js',
    'chrome/toolkit/content/global/devtools/framework/toolbox-options.js',
    'modules/devtools/shared/d3.js',
    'chrome/toolkit/content/global/devtools/d3.js',
])
