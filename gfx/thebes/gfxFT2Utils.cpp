                             ...
                             uint32_t* aSpaceGlyph)
{
    ...
    if (FT_IS_SCALABLE(mFace)) {
        ...
        if (head) {
            ...
            // color bitmaps, it should be treated as scalable and scaled
            // to the desired size. Metrics based on y_ppem need to be
            // rescaled for the adjusted size. This makes metrics agree
