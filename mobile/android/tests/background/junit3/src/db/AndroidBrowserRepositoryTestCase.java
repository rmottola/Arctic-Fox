...
import org.mozilla.goanna.background.sync.helpers.DefaultBeginDelegate;
import org.mozilla.goanna.background.sync.helpers.DefaultCleanDelegate;
import org.mozilla.goanna.background.sync.helpers.DefaultFetchDelegate;
import org.mozilla.goanna.background.sync.helpers.DefaultFinishDelegate;
import org.mozilla.goanna.background.sync.helpers.DefaultSessionCreationDelegate;
import org.mozilla.goanna.background.sync.helpers.DefaultStoreDelegate;
import org.mozilla.goanna.background.sync.helpers.ExpectBeginDelegate;
import org.mozilla.goanna.background.sync.helpers.ExpectBeginFailDelegate;
...
import org.mozilla.goanna.background.sync.helpers.ExpectFinishFailDelegate;
import org.mozilla.goanna.background.sync.helpers.ExpectGuidsSinceDelegate;
import org.mozilla.goanna.background.sync.helpers.ExpectInvalidRequestFetchDelegate;
import org.mozilla.goanna.background.sync.helpers.ExpectManyStoredDelegate;
import org.mozilla.goanna.background.sync.helpers.ExpectStoreCompletedDelegate;
